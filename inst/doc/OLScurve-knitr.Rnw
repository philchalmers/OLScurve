...
\runninghead{OLS Growth Curves in R}
\title{Ordinary Least Squares Growth Curves in R}
\author{R.\ Philip Chalmers}
\authorinfo{Department of Psychology \\ York University}
%\authornote{}
...
<<subjplot, echo=FALSE, fig.width=6, fig.align='center', fig.cap = "Title">>=
...
<<plotmod-lin, fig.cap="Figure", fig.width=5, fig.height=5, fig.align='center'>>= 
...
<<splom, eval=TRUE, fig.width=5, fig.height=5, fig.align='center', fig.cap = "Title">>=
